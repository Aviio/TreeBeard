// ==============================================================================
// This is a modified version of this.Log:LoggingExtensions.Core.LogExtensions.cs
// ==============================================================================
...
namespace TreeBeard.Extensions
{
    ...
    public static class LogExtensions
    {
        ...
        /// </summary>
        private static readonly ConcurrentDictionary<string, Log4NetLog> _dictionary = new ConcurrentDictionary<string, Log4NetLog>();
        ...
        public static Log4NetLog Log<T>(this T type)
        {
        ...
        /// <returns>Instance of a logger for the object.</returns>
        public static Log4NetLog Log(this string objectName)
        {
            return _dictionary.GetOrAdd(objectName, o => new Log4NetLog(o));
        }
    }
}